		...
		<form action="meUpdateTo.jsp">
			...
			<div class="input-group mb-3">
				<span class="input-group-text">아이디</span> <input type="text"
					class="form-control" id="fakeid" name="fakeid" value="${bean.id}"
					disabled> <span class="input-group-text">아이디</span> <input
					type="hidden" class="form-control" id="id" name="id"
					value="${bean.id}">
			</div>
			<div class="input-group mb-3">
				<span class="input-group-text">이름</span> <input type="text"
					class="form-control" id="name" name="name" value="${bean.name}">
			</div>
			<div class="input-group mb-3">
			...
			<div class="input-group mb-3">
				<span class="input-group-text">생일</span> <input type="text"
					class="form-control" id="birth" name="birth" value="${bean.birth}">
			</div>
			<div class="input-group mb-3">
			...
			<div class="input-group mb-3">
				<button type="sunmit" class="btn btn-primary"
