	...
	<div class="container mt-3">
		...
		<form action="boInsertTo.jsp">
			...
			<div class="input-group mb-3">
				...
				<input type="text" class="form-control" id="fakeid" name="fakeid" value="hong"  disabled="disabled">
				<input type="hidden" id="id" name="id" value="hong" >
			</div>
			...
			<div class="input-group mb-3">
				<button type="button" class="btn btn-primary btn_Lg" onclick="return validCheck()">등록</button>
				&nbsp;&nbsp;&nbsp;
